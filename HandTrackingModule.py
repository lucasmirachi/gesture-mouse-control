...
class handDetector():
    ...
    def findDistance(self, p1, p2, img, draw=True, r=15, t=3):
        ...
        if draw:
            ...
            cv2.line(img, (x1,y1), r, (0,0,255), cv2.FILLED)
            cv2.line(img, (x2,y2), r, (0,0,255), cv2.FILLED)
            cv2.line(img, (cx,cy), r, (0,0,255), tcv2.FILLED)
...
def main():
    ...
    while True:
        ...
        landmarksList, bbox = detector.findPositions(img)
